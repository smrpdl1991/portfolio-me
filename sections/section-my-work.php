...
<section class="section-my-work" id="section-my-work">
    <div class="container">
        <?php if(get_theme_mod('selected_work_title')){ ?>
        <div class="heading">
                        ...
                        <g id="Layer_2" data-name="Layer 2">
                            <g id="diagonal-arrow-right-up">
                                <g id="diagonal-arrow-right-up-2" data-name="diagonal-arrow-right-up">
                                    ...
                                    <path class="cls-2"
                                        d="M18,7.05a1,1,0,0,0-1-1L9,6H9A1,1,0,0,0,9,8l5.56,0L6.29,16.29a1,1,0,0,0,0,1.42,1,1,0,0,0,1.42,0L16,9.42V15a1,1,0,0,0,1,1h0a1,1,0,0,0,1-1Z" />
                                </g>
                            </g>
                        </g>
                    </svg>
        ...
        <?php } ?>
        <?php 
            $bttnLink = get_theme_mod('selected_work_view_more_link');
            if($bttnLink){ ?>
        <div class="view-more-bttn">
            <a href="<?php echo get_theme_mod('selected_work_view_more_link'); ?>"
                class="bttn"><?php echo get_theme_mod('selected_work_view_more_label'); ?></a>
        </div> <?php } ?>
    </div>
    <div class="container see-more-wrap">
        <div class="see-more">
            <h2><?php echo get_theme_mod('cta_title_work'); ?></h2>
            
            <p><?php echo get_theme_mod('cta_desc_work'); ?> <a
                    href="<?php echo esc_url(get_theme_mod('cta_desc_link')); ?>"><?php echo get_theme_mod('cta_desc_link_label'); ?></a></p>
        </div>
    </div>
</section>
<?php } ?>